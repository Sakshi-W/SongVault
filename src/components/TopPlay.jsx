...
const TopPlay = () => {
  ...
  const { data } = useGetChartsListQuery();
  ...
  return (
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500px] max-w-full flex flex-col">
      ...
      <div className="w-full flex flex-col mt-8">
        ...
        <Swiper slidesPerView="auto" spaceBetween={15} freeMode centeredSlides centeredSlidesBounce modules={[FreeMode]} className="mt-4">
          {topPlays?.map((song, i) => (
